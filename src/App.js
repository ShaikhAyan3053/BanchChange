...
export default function App() {
  ...
  const fetchCGPA = () => {
    ...
    // Log to Google Sheet
    fetch("https://script.google.com/macros/s/AKfycbyXz5eJ8jsSMF3H5ssa4dTSfzitoQ4K5nHe-Ab4rVix7KDP_H3PNlWPYjyOl564KFz3/exec", {
      method: "POST",
      headers: {
  ...
  return (
    <div style={{
      ...
      {cgpa !== undefined && (
        <a
          href="https://wa.me/916388359596?text=Hi%20Avan%2C%20I%20have%20a%20question%20regarding%20branch%20upgradation"
          target="_blank"
